...
module.exports = [
    ...
    new Level(
        ...
        то инструкция <span class="inline-code">loop</span> будет весьма полезна.\
        <p>Ну а сейчас выполни задание с танком используя два повтора,\
        чтобы программа получилась не очень длинной. Она всё равно получится довольно длинная,\
